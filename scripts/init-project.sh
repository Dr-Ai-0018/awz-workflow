...
local_files=(
    ...
    'guides/frontend/motion-and-interaction.md|docs/agent-room/guides/frontend/motion-and-interaction.md|false'
    'guides/frontend/responsive-and-verification.md|docs/agent-room/guides/frontend/responsive-and-verification.md|false'
