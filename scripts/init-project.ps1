...
$localDirs = @(
    ...
    "docs/agent-room/guides/frontend",
...
$localFiles = @(
    ...
    @{ Source = "guides/frontend/motion-and-interaction.md"; Dest = "docs/agent-room/guides/frontend/motion-and-interaction.md"; Render = $false },
    @{ Source = "guides/frontend/responsive-and-verification.md"; Dest = "docs/agent-room/guides/frontend/responsive-and-verification.md"; Render = $false },
